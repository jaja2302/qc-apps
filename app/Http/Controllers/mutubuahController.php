...
use App\Exports\Exportmutubuah;
...
class mutubuahController extends Controller
{
    ...
    public function getWeekData(Request $request)
    {
        ...
        $result = rekap_sidakmutubuah_bulan($bulan, $regional);
    ...
    public function getahun_sbi(Request $request)
    {
        ...
        $result = rekap_pertahun_mutubuah($regional, $tahun);
        // dd($tahun, $regional);
        ...
        $arrView['listregion'] =  $result['listregion'];
        $arrView['mutu_buah'] =  $result['mutu_buah'];
        $arrView['rekapmua'] =  $result['rekapmua'];
        $arrView['rhdata'] =  $result['rhdata'];
    ...
    public function pdfmutubuhuahdata(Request $request)
    {


        $regional = $request->input('getregionalexcel');
        $tanggal = $request->input('getdateexcel');

        // dd($regional, $tanggal);
        return Excel::download(new Exportmutubuah($regional, $tanggal), 'Excel Mutu Buah TPH Regonal-' . $regional . '-' . 'Bulan-' . $tanggal . '.xlsx');
    }
}
