...
class RekapController extends Controller
{
    ...
    public function getdatayear(Request $request)
    {
        ...
        $result_qc = rekap_pertahun($tahun, $regional);
        $rekap_qc = $result_qc['rekaptahunan_afdeling'];
        $result_tph = rekap_pertahun_sidaktph($regional, $tahun, null, null);
        $rekap_tph = $result_tph['newsidakend'];
        $result_mutubuah = rekap_pertahun_mutubuah($regional, $tahun);
        $rekap_mutubuah = $result_mutubuah['mutu_buah'];
