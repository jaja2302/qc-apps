...
class pdfgenerateController extends Controller
{
    ...
    public function exportExcel($id, $est, $tgl)
    {
        ...
        $result = [
            ...
            'date' => $tgl,
            'est' => $est,
            'newResult' => cetakPDFFI($id, $est, $tgl),
        ];
        return Excel::download(new Findingissue($result), 'Finding Issue -' . $tgl . '-' . 'Estate-' . $est . '.xlsx');
    }
