        ...
        <table class="custom-table" style="float: right; width: 70%; border-collapse: collapse;" border="1">
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="{{$cellspana}}" style="vertical-align: bottom; text-align: center">Asisten Tidak Terverifikasi Secara Digital</td>
                    <td colspan="{{$cellspana_second}}" style="vertical-align: bottom; text-align: center">Askep Tidak Terverifikasi Secara Digital</td>
                    <td colspan="{{$newrowspan_b}}" style="vertical-align: bottom; text-align: center">Manajer Tidak Terverifikasi Secara Digital</td>
                    @else
