    ...
    <table class="table table-responsive table-striped table-bordered">
        <thead>
            ...
            <tr>
                ...
                <th style="border:1px solid black;background-color: #f0ecec;text-align:center;vertical-align:middle;color:red" rowspan="2">JUMLAH JANJANG SPD</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="background-color:{{$bgcolor}};border:1px solid black;text-align:center;color:{{$colorkau}}">{{$value2['no_plat']}}</td>
                <td style="background-color:{{$bgcolor}};border:1px solid black;text-align:center">{{$value2['unit']}}</td>
                <td style="background-color:{{$bgcolor}};border:1px solid black;text-align:center">{{ formatangka($value2['tonase'])}}</td>
                <td style="background-color:{{$bgcolor}};border:1px solid black;text-align:center">{{ formatangka($value2['jumlah_janjang_spb'])}}</td>
                <td style="background-color:{{$bgcolor}};border:1px solid black;text-align:center">{{ formatangka($value2['jumlah_janjang_grading'])}}</td>
                <td style="background-color:{{$bgcolor}};border:1px solid black;text-align:center">{{ formatangka($value2['tonase'])}} </td>
                <td style="background-color:{{$bgcolor}};border:1px solid black;text-align:center">{{ roundangka_decimal( $value2['bjr']) }}</td>
            ...
            <tr>
                ...
                <td style="background-color:#4FB7C4;text-align: center;border:1px solid black">{{ formatangka($data['final']['tonase'])}}</td>
                <td style="background-color:#4FB7C4;text-align: center;border:1px solid black">{{ formatangka($data['final']['jumlah_janjang_spb'])}}</td>
                <td style="background-color:#4FB7C4;text-align: center;border:1px solid black">{{ formatangka($data['final']['jumlah_janjang_grading'])}}</td>
                <td style="background-color:#4FB7C4;text-align: center;border:1px solid black">{{ formatangka($data['final']['tonase'])}}</td>
                <td style="background-color:#4FB7C4;text-align: center;border:1px solid black">{{ roundangka_decimal( $data['final']['bjr']) }} </td>
