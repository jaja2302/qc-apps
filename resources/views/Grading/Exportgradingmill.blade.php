...
<body>
            ...
            <tr>
                ...
                <td style="vertical-align: bottom;text-align:center;padding-top:2px">
                    <div class="stamp-container">
                        <div class="stamp">
                            <img src="https://mobilepro.srs-ssms.com/storage/app/public/logodata/CBIpreview.png" alt="Logo" style="height: auto;width:69px">
    ...
    <footer>
        <p><strong>OS Versi</strong> {{$data['os_version']}} <strong>App Versi</strong> :{{$data['appvers']}} <strong>Tipe HP</strong> {{$data['phone_version']}}</p>
    </footer>
</body>
